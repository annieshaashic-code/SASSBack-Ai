# 🧚‍♀️ SASSBack AI — Complete Setup & Deployment GuideProject Banner

[SASSBack AI] 🎯
Basic Details
Team Name: [BUBBLO]
Team Members
Member 1: [ANNI ESHA ASHIC] - [SNM Institute of managment and technology]
Member 2: [KRISHNAPRIYA K S] - [SNM Institute of managment and technology]
Hosted Project Link
[mention your project hosted link here]

Project Description
Your fierce fairy godmother, with savage replays
The Problem statement
[Women lack real time tools to respond confidently to negtive online commentry withiout escalating conflict]

The Solution
sassback ai is an ai powered assitant that helps women generate confident, context aware replaies to negtive online commentds inreal time

Technical Details
consist of frontend interface backend server ,ocr module ,sentimental analyisis layer  ai response engine and safety filtering system 

Languages used: [e.g., JavaScript, Java ,html,app.js]

Frameworks used: [e.g., React, Django, Spring Boot]
Libraries used: [e.g., axios, pandas, JUnit]
Tools used: [antigravity,  Git, gemini API]
For Hardware:

Main components: [ocr module,sentiment,ai response generated ,safety filter.]
Specifications: [platform - web based application,responsive,ui
frontend -react.js.
